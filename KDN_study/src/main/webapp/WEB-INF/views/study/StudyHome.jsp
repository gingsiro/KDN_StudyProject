...
<link href='css/sidebar.css' rel='stylesheet' media='print' />
...
<body>
	<div style="overflow:hidden" class="container" id="side_container">
  ...
  <ul class="list-sidebar bg-defoult">
	...
	<c:if test="${ admin == 'Y' }">
		<li> <a href="categoryList.do"><i class="fa fa-calendar"></i> <span class="nav-label">카테고리 관리</span></a> </li>
				</c:if>
